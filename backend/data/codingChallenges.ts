const codingChallenges: any = {
  ...
  nodejs: [
    { title: "Create Express Server", description: "Write a basic Express server that listens on port 3000.", starterCode: "import express from 'express';\nconst app = express();\n\n// Add a GET route for '/'\n\n// Start the server\n", expectedOutput: "app.get('/', (req, res) => res.send('Hello'));\napp.listen(3000);", hint: "Use app.get() and app.listen()" },
  ...
  mongodb: [
    { title: "Define a Schema", description: "Create a Mongoose schema for a 'Product' with name (String, required) and price (Number).", starterCode: "import mongoose from 'mongoose';\n\nconst ProductSchema = new mongoose.Schema({\n  // Define fields here\n\n});", expectedOutput: "name: { type: String, required: true },\nprice: { type: Number }", hint: "Use type: String and type: Number with required" },
...
export { codingChallenges, getChallenge  };
