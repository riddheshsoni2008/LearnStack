...
import { generateQuestionsForLesson  } from '../data/quizDataDictionary';
...
async function main() {
  try {
    ...
    for (const lesson of allLessons) {
      ...
      const generatedQuestions = generateQuestionsForLesson(lesson.title, (lesson as any).topic || lesson.language);
