...
import { logExerciseCompletion  } from '../services/exerciseHistoryService';
import { checkAndAwardCertificate  } from '../services/certificateService';
...
export { getMyProgress, getTrackProgress, completeLessonDirect  };
