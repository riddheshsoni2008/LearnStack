...
const getArcadeHub = async (req, res) => {
  try {
    ...
    // Static Worlds for V1
    const worlds = [
      { id: 'world_1', name: 'Lost Variable City', description: 'Master variables to restore the city.', levelsCount: 6, order: 1 },
      { id: 'world_2', name: 'Function Factory', description: 'Fix the factory machines with functions.', levelsCount: 6, order: 2 },
      { id: 'world_3', name: 'Conditional Gate', description: 'Unlock the magic gates using logic.', levelsCount: 6, order: 3 },
      { id: 'world_4', name: 'Loop Dungeon', description: 'Defeat endless enemies with loops.', levelsCount: 6, order: 4 },
      { id: 'world_5', name: 'Array Kingdom', description: 'Organize the royal treasures.', levelsCount: 6, order: 5 }
    ];
