...
export interface IUser extends Document {
  ...
  unlockedGameAchievements: mongoose.Types.ObjectId[];
...
const UserSchema = new Schema<IUser>({
  ...
  arcadeProgress: [{
    levelId: { type: Schema.Types.ObjectId, ref: 'GameLevel' },
...
UserSchema.virtual('currentLevelProgress').get(function (this: IUser) {
  const level = this.level;
