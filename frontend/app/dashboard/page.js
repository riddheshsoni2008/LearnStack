    ...
    return (
      <div key="loading-dashboard" className="min-h-screen bg-[var(--background)] pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 animate-pulse">
          {/* Header Skeleton */}
          <div className="mb-8">
            <div className="h-8 bg-[var(--surface-light)] w-64 rounded mb-2"></div>
          ...
          <div className="glass rounded-2xl p-6 mb-8 h-[160px]">
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-9 gap-2">
              {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((i) => (
                <div key={i} className="bg-[var(--surface-light)] border border-[var(--border)] rounded-xl h-24 animate-pulse"></div>
              ))}
            </div>
          </div>

          {/* Track Progress Skeleton */}
          <div className="glass rounded-2xl p-6 mb-8 h-[220px]">
            <div className="flex items-center justify-between mb-4">
              <div className="h-4 bg-[var(--surface-light)] w-32 rounded"></div>
              <div className="h-3 bg-[var(--surface-light)] w-16 rounded"></div>
            </div>
